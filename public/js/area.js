let address = document.getElementById("address").toUpperCase()
...
else if (address.includes("ORANG KAYA BESAR IMAS") == true) {area = "B1", kampong = "OBELAITI"}
else if (address.includes("OBELAITI") == true) {area = "B1", kampong = "OBELAITI"}
...
//BELAIT
else if (address.includes("AGIS") == true) {area = "BELAIT", kampong = "AGIS"}
else if (address.includes("ANDALAU") == true) {area = "BELAIT", kampong = "ANDALAU"}
else if (address.includes("ANDUKI") == true) {area = "BELAIT", kampong = "ANDUKI"}
else if (address.includes("APAK") == true) {area = "BELAIT", kampong = "APAK"}
else if (address.includes("BADAS") == true) {area = "BELAIT", kampong = "BADAS"}
else if (address.includes("BANG") == true) {area = "BELAIT", kampong = "BANG"}
else if (address.includes("GARANG") == true) {area = "BELAIT", kampong = "GARANG"}
else if (address.includes("PUKUL") == true) {area = "BELAIT", kampong = "PUKUL"}
else if (address.includes("TAJUK") == true) {area = "BELAIT", kampong = "TAJUK"}
else if (address.includes("BENGERANG") == true) {area = "BELAIT", kampong = "BENGERANG"}
else if (address.includes("BIADONG") == true) {area = "BELAIT", kampong = "BIADONG"}
else if (address.includes("ULU") == true) {area = "BELAIT", kampong = "ULU"}
else if (address.includes("TENGAH") == true) {area = "BELAIT", kampong = "TENGAH"}
else if (address.includes("BISUT") == true) {area = "BELAIT", kampong = "BISUT"}
else if (address.includes("BUAU") == true) {area = "BELAIT", kampong = "BUAU"}
else if (address.includes("KANDOL") == true) {area = "BELAIT", kampong = "KANDOL"}
else if (address.includes("PUAN") == true) {area = "BELAIT", kampong = "PUAN"}
else if (address.includes("TUDING") == true) {area = "BELAIT", kampong = "TUDING"}
else if (address.includes("SAWAT") == true) {area = "BELAIT", kampong = "SAWAT"}
else if (address.includes("SERAWONG") == true) {area = "BELAIT", kampong = "SERAWONG"}
else if (address.includes("CHINA") == true) {area = "BELAIT", kampong = "CHINA"}
else if (address.includes("DUGUN") == true) {area = "BELAIT", kampong = "DUGUN"}
else if (address.includes("GATAS") == true) {area = "BELAIT", kampong = "GATAS"}
else if (address.includes("JABANG") == true) {area = "BELAIT", kampong = "JABANG"}
else if (address.includes("KAGU") == true) {area = "BELAIT", kampong = "KAGU"}
else if (address.includes("KAJITAN") == true) {area = "BELAIT", kampong = "KAJITAN"}
else if (address.includes("KELUYOH") == true) {area = "BELAIT", kampong = "KELUYOH"}
else if (address.includes("KENAPOL") == true) {area = "BELAIT", kampong = "KENAPOL"}
else if (address.includes("KUALA BALAI") == true) {area = "BELAIT", kampong = "KUALA BALAI"}
else if (address.includes("BALAI") == true) {area = "BELAIT", kampong = "KUALA BALAI"}
else if (address.includes("KUALA BELAIT") == true) {area = "BELAIT", kampong = "KUALA BELAIT"}
else if (address.includes("KUKUB") == true) {area = "BELAIT", kampong = "KUKUB"}
else if (address.includes("LABI") == true) {area = "BELAIT", kampong = "LABI"}
else if (address.includes("LAKANG") == true) {area = "BELAIT", kampong = "LAKANG"}
else if (address.includes("LAONG ARUT") == true) {area = "BELAIT", kampong = "LAONG ARUT"}
else if (address.includes("ARUT") == true) {area = "BELAIT", kampong = "LAONG ARUT"}
else if (address.includes("LAONG") == true) {area = "BELAIT", kampong = "LAONG ARUT"}
else if (address.includes("LIANG") == true) {area = "BELAIT", kampong = "SUNGAI LIANG"}
else if (address.includes("SUNGAI LIANG") == true) {area = "BELAIT", kampong = "SUNGAI LIANG"}
else if (address.includes("SG LIANG") == true) {area = "BELAIT", kampong = "SUNGAI LIANG"}
else if (address.includes("LUMUT") == true) {area = "BELAIT", kampong = "LUMUT"}
else if (address.includes("LORONG") == true) {area = "BELAIT", kampong = "LORONG"}
else if (address.includes("LORONG TENGAH") == true) {area = "BELAIT", kampong = "LORONG TENGAH"}
else if (address.includes("LORONG TIGA SELATAN") == true) {area = "BELAIT", kampong = "LORONG TIGA SELATAN"}
else if (address.includes("LILAS") == true) {area = "BELAIT", kampong = "LILAS"}
else if (address.includes("LUBUK LANYAP") == true) {area = "BELAIT", kampong = "LUBUK LANYAP"}
else if (address.includes("LANYAP") == true) {area = "BELAIT", kampong = "LUBUK LANYAP"}
else if (address.includes("LUBUK TAPANG") == true) {area = "BELAIT", kampong = "LUBUK TAPANG"}
else if (address.includes("TAPANG") == true) {area = "BELAIT", kampong = "LUBUK TAPANG"}
else if (address.includes("MALA'AS") == true) {area = "BELAIT", kampong = "MALA'AS"}
else if (address.includes("MALAAS") == true) {area = "BELAIT", kampong = "MALA'AS"}
else if (address.includes("MALAYAN") == true) {area = "BELAIT", kampong = "MELAYAN"}
else if (address.includes("MELAYU") == true) {area = "BELAIT", kampong = "MELAYU ASLI"}
else if (address.includes("ASLI") == true) {area = "BELAIT", kampong = "MELAYU ASLI"}
else if (address.includes("MELAYU ASLI") == true) {area = "BELAIT", kampong = "MELAYU ASLI"}
else if (address.includes("MELILAS") == true) {area = "BELAIT", kampong = "MELILAS"}
else if (address.includes("MENDARAM") == true) {area = "BELAIT", kampong = "MENDARAM"}
else if (address.includes("MENDARAM BESAR") == true) {area = "BELAIT", kampong = "MENDARAM"}
else if (address.includes("MENDARAM KECIL") == true) {area = "BELAIT", kampong = "MENDARAM"}
else if (address.includes("MERANGKING") == true) {area = "BELAIT", kampong = "MERANGKING"}
else if (address.includes("MERANGKING ULU") == true) {area = "BELAIT", kampong = "MERANGKING"}
else if (address.includes("MERANGKING HILIR") == true) {area = "BELAIT", kampong = "MERANGKING"}
else if (address.includes("MUMONG") == true) {area = "BELAIT", kampong = "MUMONG"}
else if (address.includes("PANDAN") == true) {area = "BELAIT", kampong = "PANDAN"}
else if (address.includes("PADANG") == true) {area = "BELAIT", kampong = "PADANG"}
else if (address.includes("PANAGA") == true) {area = "BELAIT", kampong = "PANAGA"}
else if (address.includes("PENGKALAN SIONG") == true) {area = "BELAIT", kampong = "PENGKALAN SIONG"}
else if (address.includes("SIONG") == true) {area = "BELAIT", kampong = "PENGKALAN SIONG"}
else if (address.includes("PENGALAYAN") == true) {area = "BELAIT", kampong = "PENGALAYAN"}
else if (address.includes("PENYRAP") == true) {area = "BELAIT", kampong = "PENYRAP"}
else if (address.includes("PERANGKONG") == true) {area = "BELAIT", kampong = "PERANGKONG"}
else if (address.includes("PERUMPONG") == true) {area = "BELAIT", kampong = "PERUMPONG"}
else if (address.includes("PESILIN") == true) {area = "BELAIT", kampong = "PESILIN"}
else if (address.includes("PULAU APIL") == true) {area = "BELAIT", kampong = "PULAU APIL"}
else if (address.includes("APIL") == true) {area = "BELAIT", kampong = "PULAU APIL"}
else if (address.includes("RAMPAYOH") == true) {area = "BELAIT", kampong = "RAMPAYOH"}
else if (address.includes("RATAN") == true) {area = "BELAIT", kampong = "RATAN"}
else if (address.includes("SAUD") == true) {area = "BELAIT", kampong = "SAUD"}
//else if (address.includes("SIMPANG") == true) {area = "BELAIT", kampong = "SIMPANG TIGA"}
else if (address.includes("SIMPANG TIGA") == true) {area = "BELAIT", kampong = "SIMPANG TIGA"}
else if (address.includes("SINGAP") == true) {area = "BELAIT", kampong = "SINGAP"}
else if (address.includes("SUKANG") == true) {area = "BELAIT", kampong = "SUKANG"}
else if (address.includes("BAKONG") == true) {area = "BELAIT", kampong = "BAKONG"}
else if (address.includes("DAMIT") == true) {area = "BELAIT", kampong = "DAMIT"}
else if (address.includes("BERA") == true) {area = "BELAIT", kampong = "BERA"}
else if (address.includes("DUHON") == true) {area = "BELAIT", kampong = "DUHON"}
else if (address.includes("GANA") == true) {area = "BELAIT", kampong = "GANA"}
else if (address.includes("HILIR") == true) {area = "BELAIT", kampong = "HILIR"}
else if (address.includes("KANG") == true) {area = "BELAIT", kampong = "KANG"}
else if (address.includes("KURU") == true) {area = "BELAIT", kampong = "KURU"}
else if (address.includes("LALIT") == true) {area = "BELAIT", kampong = "LALIT"}
else if (address.includes("LUTONG") == true) {area = "BELAIT", kampong = "LUTONG"}
else if (address.includes("MAU") == true) {area = "BELAIT", kampong = "MAU"}
else if (address.includes("MELILIT") == true) {area = "BELAIT", kampong = "MELILIT"}
else if (address.includes("PETAI") == true) {area = "BELAIT", kampong = "PETAI"}
else if (address.includes("TALI") == true) {area = "BELAIT", kampong = "TALI"}
else if (address.includes("TARING") == true) {area = "BELAIT", kampong = "TARING"}
else if (address.includes("TERABAN") == true) {area = "BELAIT", kampong = "TERABAN"}
else if (address.includes("UBAR") == true) {area = "BELAIT", kampong = "UBAR"}
else if (address.includes("TANAJOR") == true) {area = "BELAIT", kampong = "TANAJOR"}
else if (address.includes("TANJONG RANGGAS") == true) {area = "BELAIT", kampong = "TANJONG RANGGAS"}
else if (address.includes("RANGGAS") == true) {area = "BELAIT", kampong = "TANJONG RANGGAS"}
else if (address.includes("TANJONG SUDAI") == true) {area = "BELAIT", kampong = "TANJONG SUDAI"}
else if (address.includes("SUDAI") == true) {area = "BELAIT", kampong = "TANJONG SUDAI"}
else if (address.includes("TAPANG LUPAK") == true) {area = "BELAIT", kampong = "TAPANG LUPAK"}
else if (address.includes("TARAP") == true) {area = "BELAIT", kampong = "TARAP"}
else if (address.includes("TEMPINAK") == true) {area = "BELAIT", kampong = "TEMPINAK"}
else if (address.includes("TERAJA") == true) {area = "BELAIT", kampong = "TERAJA"}
else if (address.includes("TERAWAN") == true) {area = "BELAIT", kampong = "TERAWAN"}
else if (address.includes("TERUNAN") == true) {area = "BELAIT", kampong = "TERUNAN"}
else if (address.includes("TUGONG") == true) {area = "BELAIT", kampong = "TUGONG"}
else if (address.includes("TUNGULLIAN") == true) {area = "BELAIT", kampong = "TUNGULLIAN"}
else if (address.includes("UBOK") == true) {area = "BELAIT", kampong = "UBOK"}
else if (address.includes("BELAIT") == true) {area = "BELAIT", kampong = "BELAIT"}
//TE
