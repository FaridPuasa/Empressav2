function checkTrackingNum(field, autoMove) {
    if (field.value.length >= field.maxLength) {
        ...
        document.getElementById("parcelNumberArea").style.display = 'none';
        document.getElementById("areaArea").style.display = 'none';
        document.getElementById("dateArea").style.display = 'none';
        document.getElementById("loading").style.display = 'block';
        document.getElementById("wronginput").style.display = 'none';

        function checkTookan() {
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    ...
                    if (json_responsejd.status != 404) {
                        ...
                        document.getElementById("customerName").innerText = json_responsejd.data[0].customer_username;
                        document.getElementById("name").value = json_responsejd.data[0].customer_username;

                        document.getElementById("customerAddress").innerText = json_responsejd.data[0].job_address;
                        document.getElementById("address").innerText = json_responsejd.data[0].job_address;

                        document.getElementById("customerContact").innerText = json_responsejd.data[0].customer_phone;
                        ...
                        document.getElementById("parcelNumberArea").style.display = 'block';
                        document.getElementById("areaArea").style.display = 'block';
                    ...
                    if (json_responsejd.status == 404) {
                        ...
                        document.getElementById("customerContact").innerText = "Customer Contact";
            ...
            function editTask() {
                ...
                request.onreadystatechange = function () {
                    if (this.readyState === 4) {
                        ...
                        document.getElementById("dateEntry").value = moment().format('DD/MM/YYYY hh:mma');
                ...
                var body = {
                    ...
                    'meta_data': [
                        { "label": "Parcel_Number", "data": document.getElementById("parcelNumber").value },
                        { "label": "Inventory_Status", "data": "" },
                        { "label": "Arrive_Date", "data": document.getElementById("dateArrive").value }
                    ],
                    'api_key': '51676580f24b091114132d38111925401ee4c2f328d978375e1f03',
